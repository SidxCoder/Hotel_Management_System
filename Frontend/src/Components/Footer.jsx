    ...
    <div>
      <footer className=' font-poppins'>
        <div className="foot_content flex text-left justify-center gap-20 py-10 text-gray-300 bg-black">
            ...
            <div className={`part2 leading-8 `} data-aos="fade-up" data-aos-duration="1500">
            ...
            <div className={`part3 leading-8`}data-aos="fade-up" data-aos-duration="1500">
       <h2 className='font-medium text-xl mb-4'>Quick Services/Features</h2>
            ...
            <div className={`part4 `} data-aos="fade-up" data-aos-duration="1500">
